...
type EmpathySectionProps = {
  content: WorkshopContent['empathy'];
};

export function EmpathySection({ content }: EmpathySectionProps) {
  return (
    <section className="relative isolate overflow-hidden border-y border-white/10 bg-page-deep px-5 py-18 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
      <div className="absolute inset-x-0 top-0 -z-10 h-40 bg-linear-to-b from-page to-transparent" aria-hidden="true" />
